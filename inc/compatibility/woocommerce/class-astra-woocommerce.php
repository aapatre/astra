...
if ( ! class_exists( 'Astra_Woocommerce' ) ) :
	...
	class Astra_Woocommerce {
		...
		public function add_styles() {
			...
			if ( Astra_Builder_Helper::apply_flex_based_css() ) {
				$css_global_button_tablet['.woocommerce ul.products:not(.elementor-grid), .woocommerce-page ul.products:not(.elementor-grid)'] = array(
			...
			if ( ! Astra_Builder_Helper::apply_flex_based_css() ) {
				...
				$css_global_button_mobile[ '.woocommerce ul.products:not(.elementor-grid), .woocommerce-page ul.products:not(.elementor-grid), .woocommerce.mobile-columns-' . $archive_mobile_grid . ' ul.products:not(.elementor-grid), .woocommerce-page.mobile-columns-' . $archive_mobile_grid . ' ul.products:not(.elementor-grid)' ] = array(
